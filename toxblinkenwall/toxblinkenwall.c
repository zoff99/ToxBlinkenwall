...
static const char global_version_string[] = "0.99.41";
// ----------- version -----------
// ----------- version -----------
...
void *calc_network_traffic(void *data)
{
    ...
    while (networktraffic_thread_stop == 0)
    {
        ...
        if (file1)
        {
            (void)fscanf(file1, "%llu", &lan_rx_value);
            fclose(file1);
        }
        ...
        if (file1)
        {
            (void)fscanf(file1, "%llu", &lan_tx_value);
            fclose(file1);
        }
        ...
        if (file1)
        {
            (void)fscanf(file1, "%llu", &wifi_rx_value);
            fclose(file1);
        }
        ...
        if (file1)
        {
            (void)fscanf(file1, "%llu", &wifi_tx_value);
            fclose(file1);
        }
